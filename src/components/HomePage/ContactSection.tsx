        ...
        <SectionCard>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href={(socialLinks.whatsapp as string) || "#"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-[var(--accent-muted)] rounded-lg hover:bg-[var(--success)] hover:text-black transition-all group">
                <MessageCircle className="group-hover:text-black" size={20} />
                <span className="font-medium">Chat on WhatsApp</span>
              </a>

              <a href={(socialLinks.linkedin as string) || "#"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-[var(--accent-muted)] rounded-lg hover:bg-[var(--accent-secondary)] hover:text-white transition-all group">
