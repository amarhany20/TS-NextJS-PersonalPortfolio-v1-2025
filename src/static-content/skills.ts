...
export const skillGroups: readonly SkillGroupDisplay[] = [
  {
    ...
    skills: [{ name: 'Node.js' }, { name: 'TypeScript' }, { name: 'REST APIs' }],
  },
  {
    id: 'frontend',
    title: 'Frontend',
    summary: 'UI engineering and design systems.',
    skills: [{ name: 'Next.js' }, { name: 'React' }, { name: 'Tailwind CSS' }],
  },
  {
    id: 'databases',
    title: 'Databases',
    summary: 'Relational databases and data modeling.',
    skills: [{ name: 'PostgreSQL' }, { name: 'SQLite' }],
  },
  {
    id: 'cloud-devops',
    title: 'Cloud & DevOps',
    summary: 'Deployment and automation.',
    skills: [{ name: 'Docker' }, { name: 'GitHub Actions' }],
  },
  {
    id: 'soft-skills',
    title: 'Soft Skills',
