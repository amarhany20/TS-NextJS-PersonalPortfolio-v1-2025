    ...
    <section className="space-y-8 py-6">
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-sm text-[var(--text-secondary)]">
          Edit your name, main hero copy, and core contact details here. These values feed the
          public profile/sidebar, hero section, and contact section after the first-run bootstrap.
        </p>
      </header>
