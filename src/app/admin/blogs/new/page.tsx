  ...
  return (
    <section className="space-y-8 py-6">
      <header className="flex flex-wrap items-center gap-4">
        <div>
          ...
          <p className="text-sm text-[var(--text-secondary)]">
            Draft copy with the rich text surface, pick statuses, and schedule a publish date.
            Changes queue instantly to the API.
          </p>
        </div>
        <Link
          href="/admin/blogs"
      ...
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--card-bg)] p-6 shadow-lg shadow-black/10">
        <BlogEditorForm mode="create" categories={categories} tags={tags} />
      </div>
    </section>
  );
}
